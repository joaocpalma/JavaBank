...
public class RestAccountController {
    ...
    public ResponseEntity<?> addAccount(@PathVariable Integer cid, @Valid @RequestBody AccountDto accountDto, BindingResult bindingResult) {
        ...
        try {
            ...
            customerService.addAccount(cid, accountDtoToAccount.convert(accountDto));
     ...
     * @return the response entity
     */
    @RequestMapping(method = RequestMethod.DELETE, path = "/{cid}/account/{aid}/close")
