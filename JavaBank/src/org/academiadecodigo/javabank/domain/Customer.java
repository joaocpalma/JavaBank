...
public class Customer {
    ...
    public Customer(int id, String name, AccountManager accountManager,Bank bank){
        this.id = id;
        this.name = name;
     ...
     */
    public int openAccount(AccountType accountType, int id) {
        Account account = accountManager.openAccount(accountType,id);
